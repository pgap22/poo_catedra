        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        'mw-red': '#AC5F5FBD', // El rojo que proporcionaste
                        'mw-bg': '#181818',
                        'mw-sidebar': '#272727',
...
<main class="flex-1 p-8">
    <h1 class="text-2xl font-bold text-mw-text-light mb-2">Empleado</h1>
    <p class="text-sm text-mw-text-secondary mb-6">Administra tus empleados</p>

    <section class="bg-mw-card rounded-md p-6">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-lg font-bold text-mw-text-light">Empleado #1 <button id="openDeleteModal" class="bg-mw-red text-mw-text-light rounded-md py-2 px-4 text-sm ml-2">Borrar</button></h2>
        </div>
        ...
        <p class="text-xs text-mw-text-secondary mb-1">Fecha de actualizacion: 2021-02-21</p>
        <p class="text-xs text-mw-text-secondary mb-6">Fecha de inactivacion:</p>

        <div class="grid grid-cols-2 gap-y-2 text-sm text-mw-text-light">
            <div><span class="font-semibold">Nombre del trabajador</span></div>
            <div class="flex items-center justify-end"><span class="text-mw-text-secondary">Demo</span>
            ...
            <div><span class="font-semibold">Documento de Identificación</span></div>
            ...
            <div><span class="font-semibold">Tipo de contratación</span></div>
            <div class="flex items-center justify-end"><span class="text-mw-text-secondary">Permanente</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-mw-text-light cursor-pointer ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.687a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931m0 0L19.5 7.125m-2.633 4.26l-1.062-.062a1.125 1.125 0 01-1.143 1.143l-.062 1.062" />
                </svg>
            </div>
            <div><span class="font-semibold">Número de teléfono</span></div>
            <div class="flex items-center justify-end"><span class="text-mw-text-secondary">2022-1002</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-mw-text-light cursor-pointer ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.687a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931m0 0L19.5 7.125m-2.633 4.26l-1.062-.062a1.125 1.125 0 01-1.143 1.143l-.062 1.062" />
                </svg>
            </div>
            <div><span class="font-semibold">Correo de contacto</span></div>
            <div class="flex items-center justify-end"><span class="text-mw-text-secondary">demo@demo.com</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-mw-text-light cursor-pointer ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.687a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931m0 0L19.5 7.125m-2.633 4.26l-1.062-.062a1.125 1.125 0 01-1.143 1.143l-.062 1.062" />
                </svg>
            </div>
            <div><span class="font-semibold">Dirección</span></div>
            <div class="flex items-center justify-end"><span class="text-mw-text-secondary">Calle Pt2 Av Test</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-mw-text-light cursor-pointer ml-2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.687a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931m0 0L19.5 7.125m-2.633 4.26l-1.062-.062a1.125 1.125 0 01-1.1431.143l-.062 1.062" />
                </svg>
            </div>
